import { Heart, Menu, PanelLeftClose } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#fbfbfc] text-slate-950">
      ...
      <div className="min-h-screen lg:pl-64">
        <header className="flex h-18 items-center justify-between border-b border-slate-200 bg-white px-5 lg:h-20 lg:px-10">
          ...
          <div className="ml-auto flex items-center gap-3"><span className="hidden text-sm text-slate-500 sm:inline">Welcome to Nila</span><span className="grid size-9 place-items-center rounded-full bg-[#eef1f8] text-xs font-semibold text-[#5268a5]">N</span></div>
        </header>
